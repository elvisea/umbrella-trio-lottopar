defmodule UmbrellaTrioLottoparWeb.Finance.Deposit do
  ...
  def changeset(deposit, attrs) do
    deposit
    |> cast(attrs, [:player_id, :op_id, :txn_amount, :tax_amount, :wallet_affected_amount, :txn_status, :txn_date, :txn_mode, :process_charges, :codigo_lottopar, :ref_txn_id, :payment_type, :sub_payment_type, :service_charges, :tp_txn_id, :retail_data])
    |> validate_required([:player_id, :op_id, :txn_amount, :tax_amount, :wallet_affected_amount, :txn_status, :txn_date, :txn_mode, :process_charges, :codigo_lottopar, :ref_txn_id, :payment_type, :sub_payment_type, :service_charges, :tp_txn_id])
  end
end
